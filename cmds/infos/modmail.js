...
function modmailInfo(message, client,prefix, config, f){
    if (message.content.toLowerCase().startsWith(prefix + 'modmail')){
        ...
        embed.setDescription('Le modmail est un outil permettant de contacter les admins et modérateurs du serveurs pour signaler quelqu\'un.\nPour l\'utiliser, il faut ouvrir un ticket en message privé à moi en tapant la même commande')
